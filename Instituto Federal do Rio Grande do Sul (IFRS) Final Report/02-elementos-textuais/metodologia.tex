...
Quanto a metodologia de desenvolvimento, utilizou-se a UML que, segundo \citeonline{fowler14} é uma família de notações gráficas, apoiadas por um modelo único, que ajuda na descrição e no projeto de sistemas de software, particularmente daqueles construídos utlizando o paradigma orientado a objetos.
