...
\begin{document}
    ...
    \include{./01-elementos-pre-textuais/epigrafe}           % Pula uma folha
    ...
    %\include{./01-elementos-pre-textuais/folhaCatalografica}% Não sei o que é isso
    ...
    \include{./02-elementos-textuais/objetivos}              % Objetivos
    \include{./02-elementos-textuais/metodologia}            % Metodologia
    \include{./02-elementos-textuais/fundTeorica}            % Fundamentação Teórica
    \include{./02-elementos-textuais/trabsRelacionados}      % Trabalhos Relacionados
    \include{./02-elementos-textuais/tecnologias}            % Tecnologias utilizadas
    \include{./02-elementos-textuais/resultados}             % Resultados
    \include{./02-elementos-textuais/trabsFuturos}           % Trabalhos Futuros 
