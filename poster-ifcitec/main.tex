...
\begin{center}
%% TITLE
\textbf{\bf\veryHuge\color{NavyBlue}Lorem ipsum dolor\\[1.5cm]}

%% AUTHORS

\huge A. Turing$^{1*}$, C.F. Gau{\ss}$^1$, J. von Neumann$^1$, R.P. Feynman$^2$\\[0.3cm]
\huge $^1$Depto de Computação e Matemática, FFCLRP/USP\\[0.3cm]
...
dolor sit amet, consectetur adipiscing elit. Phasellus vel sem
magna. Nunc at convallis urna. isus ante. Pellentesque condimentum
dui. 
